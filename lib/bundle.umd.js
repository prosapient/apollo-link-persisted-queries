(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ? define(['exports', 'apollo-link', 'graphql/language/printer'], factory)
      : factory(
          (global.persistedQueryLink = {}),
          global.apolloLink,
          global.graphql_language_printer,
        );
})(this, function(exports, apolloLink, graphql_language_printer) {
  'use strict';
  ...
  var serverSupportsPersistedQueries = function(_a) {
      ...
      return new apolloLink.Observable(function(observer) {
        ...
        var retry = function(_a, cb) {
          ...
          if (!retried && ((response && response.errors) || networkError)) {
            ...
            supportsPersistedQueries = serverSupportsPersistedQueries(
              disablePayload,
            );
            var disabled = disable(disablePayload);
            var queryNotFound =
              response &&
              response.errors &&
            ...
            if (queryNotFound || !supportsPersistedQueries || !disabled) {
