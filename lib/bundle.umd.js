...
var defaultOptions = {
    ...
    disable: function (_a) {
        var operation = _a.operation, graphQLErrors = _a.graphQLErrors;
        ...
        return new apolloLink.Observable(function (observer) {
            ...
            var retry = function (_a, cb) {
                ...
                if (!retried && ((response && response.errors) || networkError)) {
                    ...
                    supportsPersistedQueries = serverSupportsPersistedQueries(disablePayload);
                    var disabled = disable(disablePayload);
                    var queryNotFound = response &&
                        response.errors &&
